...
item replace block ~ ~ ~ container.4 with minecraft:rabbit_spawn_egg{display:{Name:'{"text":"ctg_aiturn_north"}'},EntityTag:{NoGravity:1b,Silent:1b,Invulnerable:1b,NoAI:1b,Tags:["ctg_aiturn"],CustomName:'{"text":"ctg_aiturn5"}',ActiveEffects:[{Id:14b,Amplifier:1b,Duration:9999}]}}
