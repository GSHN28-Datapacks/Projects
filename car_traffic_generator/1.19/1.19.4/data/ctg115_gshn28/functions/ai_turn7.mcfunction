...
item replace block ~ ~ ~ container.6 with minecraft:rabbit_spawn_egg{display:{Name:'{"text":"ctg_aiturn_east"}'},EntityTag:{NoGravity:1b,Silent:1b,Invulnerable:1b,NoAI:1b,Tags:["ctg_aiturn"],CustomName:'{"text":"ctg_aiturn7"}',ActiveEffects:[{Id:14,Amplifier:1b,Duration:9999}]}}
