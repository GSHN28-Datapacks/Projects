...
item replace block ~ ~ ~ container.5 with minecraft:rabbit_spawn_egg{display:{Name:'{"text":"ctg_aiturn_northeast"}'},EntityTag:{NoGravity:1b,Silent:1b,Invulnerable:1b,NoAI:1b,Tags:["ctg_aiturn"],CustomName:'{"text":"ctg_aiturn6"}',ActiveEffects:[{Id:14,Amplifier:1b,Duration:9999}]}}
