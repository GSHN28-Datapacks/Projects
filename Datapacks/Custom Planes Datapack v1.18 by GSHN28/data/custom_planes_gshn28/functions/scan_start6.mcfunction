summon armor_stand ~2 ~-1 ~-12 {CustomNameVisible:0b,Tags:["cplane6"],NoGravity:1b,Invulnerable:1b,Invisible:0b,PersistenceRequired:1b,CustomName:"{\"text\":\"cplane_scanner\"}"}
...
kill @e[name=!cplane_scanner,tag=cplane6]
