...
summon armor_stand ~ ~1 ~ {NoGravity:1b,Invulnerable:1b,Invisible:1b,Tags:["celev_north"],CustomName:"{\"text\":\"celev_setup\"}"}
summon armor_stand ~ ~1.15 ~ {NoGravity:1b,Invulnerable:1b,Invisible:1b,Tags:["celev","celev_north","celev_Spawn","celev_model_modern","celev_modelupdate"],CustomName:"{\"text\":\"celevator\"}"}
